const id = "post11.md";
						...
						const data = {title:"Python Selfbots and Webhooks in Discord Pt. 1",pubDate:new Date(1720396800000),pubTime:12,views:1500,description:"Creating custom Discord selfbots when Discord's Webhooks aren't enough. With a dash of Python and a dab of Chrome Dev tools. Creating custom Discord selfbots when Discord's Webhooks aren't enough. With a dash of Python and a dab of Chrome Dev tools.",image:{src:
						new Proxy({"src":"/_astro/project2.vq7L2kCW.jpeg","width":864,"height":576,"format":"jpg","fsPath":"C:/upwork/matthew-portfolio/src/content/blog/images/project2.jpeg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/upwork/matthew-portfolio/src/content/blog/images/project2.jpeg";
							}
					...
					,alt:"A picture of a coder"}};
						const _internal = {
							type: 'content',
							filePath: "C:/upwork/matthew-portfolio/src/content/blog/post11.md",
							rawData: undefined,
						};
